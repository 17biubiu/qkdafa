...
function registerMicroApps(apps, lifeCycles) {
  ...
  unregisteredApps.forEach(function (app) {
    var name = app.name,
        ...
        _a = app.loader,
        loader = _a === void 0 ? _noop2.default : _a,
        props = app.props,
        ...
        return (0, _tslib.__awaiter)(_this, void 0, void 0, function () {
          ...
          return (0, _tslib.__generator)(this, function (_b) {
            switch (_b.label) {
              ...
              case 2:
                _a = _b.sent(), mount = _a.mount, otherMicroAppConfigs = (0, _tslib.__rest)(_a, ["mount"]);
                return [2
                /*return*/
                , (0, _tslib.__assign)({
                  mount: (0, _tslib.__spread)([function () {
                    return (0, _tslib.__awaiter)(_this, void 0, void 0, function () {
                  ...
                  }], (0, _utils.toArray)(mount), [function () {
                    return (0, _tslib.__awaiter)(_this, void 0, void 0, function () {
                      return (0, _tslib.__generator)(this, function (_a) {
                        return [2
                        /*return*/
